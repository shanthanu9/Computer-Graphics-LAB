...
void drawLineAndScale(struct point p1, struct point p2, int sx, int sy) {
...
void display() {
    ...
    for(int i = 0; i < n-1; i++) {
        drawLineAndScale(points[i], points[i+1], sx, sy);
    }
    drawLineAndScale(points[n-1], points[0], sx, sy);
